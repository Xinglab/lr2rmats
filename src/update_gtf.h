...
typedef struct {
    uint8_t input_mode; samFile *gtf_bam; FILE *sj_fp; 
    uint8_t use_multi:1, keep_min_set:1, force_strand:1; 
    int min_sj_cnt, min_exon, min_intron, max_delet, ss_dis, end_dis, full_level, split_trans;
